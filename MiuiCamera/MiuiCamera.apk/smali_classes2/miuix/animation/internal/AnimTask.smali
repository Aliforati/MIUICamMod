...
# instance fields
.field public mNotRunList:Ljava/util/List;
...
.field public mQueueList:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.field public mRunningList:Ljava/util/concurrent/ConcurrentLinkedQueue;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public mUpdateMap:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/Object;",
...
.method private handleSameAnim(Lmiuix/animation/internal/AnimRunningInfo;Lmiuix/animation/internal/AnimRunningInfo;)V
    ...
    iget-object v7, p1, Lmiuix/animation/internal/AnimRunningInfo;->property:Lmiuix/animation/property/FloatProperty;
...
.method private startTransition(JLmiuix/animation/internal/TransitionInfo;)V
    ...
    iget-object v1, p0, Lmiuix/animation/internal/AnimTask;->mTarget:Lmiuix/animation/IAnimTarget;
    ...
    const-string p2, "startTransition, trans.toPropValues.isEmpty"
...
# virtual methods
.method public addTransition(JLmiuix/animation/internal/TransitionInfo;)V
    .locals 4
...
.method public varargs end([Lmiuix/animation/property/FloatProperty;)V
    .locals 8
