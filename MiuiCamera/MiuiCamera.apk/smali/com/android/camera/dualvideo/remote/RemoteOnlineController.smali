...
.field public final mRemoteDeviceDict:Landroid/util/SparseArray;
...
.method public constructor <init>(Lcom/android/camera/ActivityBase;)V
    ...
    iput-object v0, p0, Lcom/android/camera/dualvideo/remote/RemoteOnlineController;->mRemoteDeviceDict:Landroid/util/SparseArray;
    ...
    invoke-virtual {p1}, Lcom/xiaomi/camera/rcs/network/NetworkStateMachine;->start()V
...
.method public declared-synchronized connect(I)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/camera/dualvideo/remote/RemoteOnlineController;->mRemoteDeviceDict:Landroid/util/SparseArray;
...
.method public declared-synchronized getConnectedRemoteDevice()Lcom/android/camera/dualvideo/remote/RemoteDevice;
    ...
    :goto_0
    iget-object v1, p0, Lcom/android/camera/dualvideo/remote/RemoteOnlineController;->mRemoteDeviceDict:Landroid/util/SparseArray;
    ...
    sget-object v2, Lcom/android/camera/dualvideo/remote/RemoteOnlineController;->TAG:Ljava/lang/String;
...
.method public declared-synchronized getRemoteDeviceById(I)Lcom/android/camera/dualvideo/remote/RemoteDevice;
    .locals 1
...
.method public declared-synchronized onConnectionResult(IILjava/lang/String;I)V
    ...
    invoke-static {p1, p4}, Lcom/xiaomi/camera/rcs/util/RCSDebug;->d(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p1, p0, Lcom/android/camera/dualvideo/remote/RemoteOnlineController;->mRemoteDeviceDict:Landroid/util/SparseArray;
...
.method public declared-synchronized onEndpointFound(IILjava/lang/String;[B)V
    ...
    new-instance p1, Lcom/android/camera/dualvideo/remote/RemoteDevice;

    invoke-direct {p1, p2, p3}, Lcom/android/camera/dualvideo/remote/RemoteDevice;-><init>(ILjava/lang/String;)V

    iget-object p3, p0, Lcom/android/camera/dualvideo/remote/RemoteOnlineController;->mRemoteDeviceDict:Landroid/util/SparseArray;
    ...
    iput p2, p1, Lcom/android/camera/dualvideo/remote/RemoteDevice;->availability:I

    iget-object p2, p0, Lcom/android/camera/dualvideo/remote/RemoteOnlineController;->mAvailabilityCallback:Lcom/android/camera/dualvideo/remote/AvailabilityCallback;

    if-eqz p2, :cond_1

    iget-object p2, p0, Lcom/android/camera/dualvideo/remote/RemoteOnlineController;->mAvailabilityCallback:Lcom/android/camera/dualvideo/remote/AvailabilityCallback;

    invoke-interface {p2, p1}, Lcom/android/camera/dualvideo/remote/AvailabilityCallback;->onAvailabilityStateChanged(Lcom/android/camera/dualvideo/remote/RemoteDevice;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized onPayloadReceived(II[B)V
    ...
    const-string v0, "connection: succeed (port received)"
    ...
    iget-object p3, p2, Lcom/android/camera/dualvideo/remote/RemoteDevice;->ip:Ljava/lang/String;
...
.method public declared-synchronized populateRemoteDeviceList(Ljava/util/List;)I
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :goto_0
    iget-object v2, p0, Lcom/android/camera/dualvideo/remote/RemoteOnlineController;->mRemoteDeviceDict:Landroid/util/SparseArray;
...
.method public declared-synchronized setLayoutType(I)V
    ...
    invoke-virtual {v0, v1, p1}, Ltv/danmaku/ijk/media/player/IjkMediaPlayer;->setParameter(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized setRecordingState(I)V
    ...
    const-string/jumbo v1, "recstate"
...
.method public declared-synchronized startStreaming(Ljava/lang/String;Landroid/view/Surface;)V
    ...
    invoke-virtual {v0, v3, v1, v9, v10}, Ltv/danmaku/ijk/media/player/IjkMediaPlayer;->setOption(ILjava/lang/String;J)V
    ...
    iput-boolean v3, p0, Lcom/android/camera/dualvideo/remote/RemoteOnlineController;->mIsStreaming:Z
    :try_end_2
