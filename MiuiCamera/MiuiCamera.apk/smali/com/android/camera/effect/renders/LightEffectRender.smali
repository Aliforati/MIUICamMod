...
.method private getCropOperationForCapture(I)Lcom/android/camera/effect/renders/LightEffectRender$CropOperation;
    ...
    invoke-static {v4, p1}, Lcom/android/camera/log/Log;->w(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-direct {v4, v5, p1, v2, v3}, Landroid/graphics/Rect;-><init>(IIII)V

    iput-object v4, v0, Lcom/android/camera/effect/renders/LightEffectRender$CropOperation;->rect:Landroid/graphics/Rect;
...
.method private prepareLightEffect(I)V
    ...
    const-string v2, "prepareLightEffect: "
...
.method private updateLightTexture(I)V
    ...
    const-string/jumbo v1, "updateLightTexture rotation(%d) bitmap(%d,%d,%d,%d) preview(%d,%d) mIsSnapshot(%b)"
