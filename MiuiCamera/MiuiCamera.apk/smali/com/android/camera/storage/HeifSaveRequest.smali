...
.method private saveHeifFile(Landroid/media/Image;[BLjava/lang/String;Landroid/util/Size;Landroid/os/Handler;III)Z
    ...
    const-string p7, "prepare buffer cost %dms"
    ...
    invoke-static {p4, p7, p8}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
...
.method private saveHeifInfo(Landroid/content/Context;Ljava/lang/String;JLandroid/location/Location;IIIZ)Landroid/net/Uri;
    ...
    const-string/jumbo v4, "saveHeifInfo: E. "
    ...
    invoke-static {v10, v14, v3}, Lcom/android/camera/storage/Storage;->getMediaUri(Landroid/content/Context;ZLjava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static/range {v1 .. v7}, Lcom/android/camera/storage/Storage;->updateHeifInfo(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Landroid/location/Location;III)Landroid/net/Uri;
    ...
    const-string/jumbo v4, "saveHeifInfo: X. updated "
    ...
    const-string/jumbo v4, "saveHeifInfo: %s task"

    invoke-static {v1, v4, v2}, Lcom/android/camera/log/Log;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    iget-object v2, v0, Lcom/android/camera/storage/HeifSaveRequest;->mContext:Landroid/content/Context;

    invoke-static {v2, v12, v14}, Lcom/xiaomi/camera/parallelservice/util/ParallelUtil;->markTaskFinish(Landroid/content/Context;Lcom/android/camera/db/element/SaveTask;Z)V
...
.method public save()V
    ...
    iget-object v1, v10, Lcom/android/camera/storage/HeifSaveRequest;->mCaptureResult:Landroid/hardware/camera2/CaptureResult;

    iget v2, v10, Lcom/android/camera/storage/HeifSaveRequest;->mWidth:I

    iget v3, v10, Lcom/android/camera/storage/HeifSaveRequest;->mHeight:I
    ...
    iget v5, v10, Lcom/android/camera/storage/HeifSaveRequest;->mWidth:I

    iget v6, v10, Lcom/android/camera/storage/HeifSaveRequest;->mHeight:I

    iget-object v1, v10, Lcom/android/camera/storage/HeifSaveRequest;->mYuvImage:Landroid/media/Image;

    if-eq v5, v6, :cond_0

    iget-object v4, v10, Lcom/android/camera/storage/HeifSaveRequest;->mHandler:Landroid/os/Handler;
    ...
    iget v6, v10, Lcom/android/camera/storage/HeifSaveRequest;->mWidth:I

    iget v7, v10, Lcom/android/camera/storage/HeifSaveRequest;->mHeight:I
    ...
    iget-object v1, v10, Lcom/android/camera/storage/HeifSaveRequest;->mContext:Landroid/content/Context;

    iget v7, v10, Lcom/android/camera/storage/HeifSaveRequest;->mWidth:I

    iget v8, v10, Lcom/android/camera/storage/HeifSaveRequest;->mHeight:I
