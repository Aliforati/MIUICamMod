...
.field public info:Lcom/xiaomi/camera/core/PictureInfo;
...
.method public constructor <init>(Lcom/xiaomi/camera/core/ParallelTaskData;Lcom/android/camera/storage/SaverCallback;Z)V
    .locals 0
...
.method public save()V
    ...
    iget-object v0, v1, Lcom/android/camera/storage/PreviewSaveRequest;->data:[B
    ...
    const-string/jumbo v5, "save preview: task is exist! isValid = "
    ...
    iget-object v3, v1, Lcom/android/camera/storage/PreviewSaveRequest;->context:Landroid/content/Context;
    ...
    iget-wide v3, v1, Lcom/android/camera/storage/AbstractSaveRequest;->date:J
    ...
    iget-boolean v3, v1, Lcom/android/camera/storage/PreviewSaveRequest;->noGaussian:Z
    ...
    iget-object v3, v1, Lcom/android/camera/storage/PreviewSaveRequest;->algorithmName:Ljava/lang/String;
    ...
    :goto_1
    iget-object v8, v1, Lcom/android/camera/storage/PreviewSaveRequest;->context:Landroid/content/Context;

    iget-wide v10, v1, Lcom/android/camera/storage/AbstractSaveRequest;->date:J

    iget-object v12, v1, Lcom/android/camera/storage/PreviewSaveRequest;->loc:Landroid/location/Location;

    iget v13, v1, Lcom/android/camera/storage/PreviewSaveRequest;->orientation:I

    iget-object v14, v1, Lcom/android/camera/storage/PreviewSaveRequest;->data:[B

    iget-boolean v15, v1, Lcom/android/camera/storage/PreviewSaveRequest;->isHeic:Z

    iget v3, v1, Lcom/android/camera/storage/PreviewSaveRequest;->width:I

    iget v9, v1, Lcom/android/camera/storage/PreviewSaveRequest;->height:I
    ...
    iget-boolean v6, v1, Lcom/android/camera/storage/PreviewSaveRequest;->isParallelProcess:Z

    iget-object v7, v1, Lcom/android/camera/storage/PreviewSaveRequest;->algorithmName:Ljava/lang/String;

    iget-object v5, v1, Lcom/android/camera/storage/PreviewSaveRequest;->info:Lcom/xiaomi/camera/core/PictureInfo;

    iget-boolean v4, v1, Lcom/android/camera/storage/PreviewSaveRequest;->noGaussian:Z
    ...
    iget-boolean v4, v1, Lcom/android/camera/storage/PreviewSaveRequest;->needThumbnail:Z

    if-eqz v4, :cond_5

    iget-object v4, v1, Lcom/android/camera/storage/PreviewSaveRequest;->saverCallback:Lcom/android/camera/storage/SaverCallback;
    ...
    iget v4, v1, Lcom/android/camera/storage/PreviewSaveRequest;->width:I

    int-to-double v4, v4

    iget v6, v1, Lcom/android/camera/storage/PreviewSaveRequest;->height:I
    ...
    iget-object v5, v1, Lcom/android/camera/storage/PreviewSaveRequest;->data:[B

    iget v6, v1, Lcom/android/camera/storage/PreviewSaveRequest;->orientation:I
    ...
    iget-object v5, v1, Lcom/android/camera/storage/PreviewSaveRequest;->saverCallback:Lcom/android/camera/storage/SaverCallback;
    ...
    iget-object v0, v1, Lcom/android/camera/storage/PreviewSaveRequest;->saverCallback:Lcom/android/camera/storage/SaverCallback;
