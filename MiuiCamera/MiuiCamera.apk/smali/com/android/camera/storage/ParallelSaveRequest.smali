...
.method private parseDocAndSave(ILjava/lang/String;Lcom/android/zxing/PreviewImage;[FLjava/lang/String;Landroid/net/Uri;)V
    ...
    invoke-static {v2, v4, v3, v0, v6}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    const-string v4, "parseDocAndSave: save "
...
.method private refreshThumbnail(ILjava/lang/String;Landroid/net/Uri;)V
    ...
    iget-object v1, p0, Lcom/android/camera/storage/ParallelSaveRequest;->mData:[B

    const/4 v2, 0x0

    invoke-static {v1, p1, v0, p3, v2}, Lcom/android/camera/Thumbnail;->createThumbnail([BIILandroid/net/Uri;Z)Lcom/android/camera/Thumbnail;
    ...
    invoke-interface {v0, p1, v2}, Lcom/android/camera/storage/SaverCallback;->postUpdateThumbnail(Lcom/android/camera/Thumbnail;Z)V
    ...
    invoke-interface {p1, p3, p2, v0}, Lcom/android/camera/storage/SaverCallback;->notifyNewMediaData(Landroid/net/Uri;Ljava/lang/String;I)V
...
.method public reFillSaveRequest([BJJLandroid/location/Location;ILjava/lang/String;IIZLjava/lang/String;Lcom/xiaomi/camera/core/PictureInfo;)V
    .locals 0
...
.method public save()V
    ...
    :cond_0
    iget v1, v8, Lcom/android/camera/storage/AbstractSaveRequest;->width:I

    iget v2, v8, Lcom/android/camera/storage/AbstractSaveRequest;->height:I

    iget-object v3, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mData:[B

    invoke-static {v3}, Lcom/android/gallery3d/exif/ExifHelper;->getOrientation([B)I

    move-result v3

    iget v4, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mJpegRotation:I
    ...
    iget v7, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mJpegRotation:I
    ...
    iget-object v4, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mContext:Landroid/content/Context;
    ...
    :cond_3
    iget-object v10, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mContext:Landroid/content/Context;

    iget-object v11, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mData:[B

    iget-boolean v12, v8, Lcom/android/camera/storage/ParallelSaveRequest;->isHeic:Z

    const/4 v13, 0x0

    iget-object v4, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mLocation:Landroid/location/Location;
    ...
    iget-object v5, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mAlgorithmName:Ljava/lang/String;

    iget-object v14, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mInfo:Lcom/xiaomi/camera/core/PictureInfo;
    ...
    invoke-direct {v8, v3, v6, v1}, Lcom/android/camera/storage/ParallelSaveRequest;->refreshThumbnail(ILjava/lang/String;Landroid/net/Uri;)V

    :cond_4
    :goto_1
    iget-object v1, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mContext:Landroid/content/Context;

    const/4 v4, 0x0

    invoke-static {v1, v0, v4}, Lcom/xiaomi/camera/parallelservice/util/ParallelUtil;->markTaskFinish(Landroid/content/Context;Lcom/android/camera/db/element/SaveTask;Z)V
    ...
    :cond_6
    iget-wide v5, v8, Lcom/android/camera/storage/AbstractSaveRequest;->date:J
    ...
    iget-wide v12, v8, Lcom/android/camera/storage/AbstractSaveRequest;->date:J

    iget-object v14, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mLocation:Landroid/location/Location;

    iget-object v6, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mData:[B

    iget-boolean v7, v8, Lcom/android/camera/storage/ParallelSaveRequest;->isHeic:Z
    ...
    :goto_4
    iget-object v11, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mAlgorithmName:Ljava/lang/String;

    iget-object v4, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mInfo:Lcom/xiaomi/camera/core/PictureInfo;
    ...
    iget-boolean v6, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mNeedThumbnail:Z
    ...
    iget-object v7, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mData:[B
    ...
    iget-object v7, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mSaverCallback:Lcom/android/camera/storage/SaverCallback;

    invoke-interface {v7, v6, v0}, Lcom/android/camera/storage/SaverCallback;->postUpdateThumbnail(Lcom/android/camera/Thumbnail;Z)V
    ...
    :cond_8
    iget-object v6, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mSaverCallback:Lcom/android/camera/storage/SaverCallback;
    ...
    iget-object v0, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mContext:Landroid/content/Context;
    ...
    iget-object v2, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mData:[B
    ...
    iget-object v2, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mSaverCallback:Lcom/android/camera/storage/SaverCallback;

    invoke-interface {v2, v1, v0}, Lcom/android/camera/storage/SaverCallback;->postUpdateThumbnail(Lcom/android/camera/Thumbnail;Z)V
    ...
    iget-object v0, v8, Lcom/android/camera/storage/ParallelSaveRequest;->mSaverCallback:Lcom/android/camera/storage/SaverCallback;
