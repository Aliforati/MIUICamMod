...
.field public static final FRONT_MAKEUPS:I = 0xbc
...
.method public static createConfigItem(I)Lcom/android/camera/data/data/config/TopConfigItem;
    .locals 1
...
.method public static createConfigItem(II)Lcom/android/camera/data/data/config/TopConfigItem;
    .locals 1
...
.method public static final getSupportedExtraConfigs(IILcom/android/camera2/CameraCapabilities;Z)Lcom/android/camera/data/data/config/SupportedConfigs;
    ...
    invoke-virtual {v6}, Lcom/android/camera/data/data/global/DataItemGlobal;->isVideoCastIntent()Z
    ...
    invoke-virtual {v5}, LOooO0O0/OooO0o0/OooO00o/OooO0O0;->o0000O00()Z
    ...
    invoke-virtual {v5}, LOooO0O0/OooO0o0/OooO00o/OooO0O0;->oo0oOO0()Z
    ...
    :cond_a
    invoke-virtual {v5}, LOooO0O0/OooO0o0/OooO00o/OooO0O0;->o00o0oo()Z
    ...
    :cond_b
    invoke-virtual {v5}, LOooO0O0/OooO0o0/OooO00o/OooO0O0;->o0O00000()Z
    ...
    invoke-virtual {v5}, LOooO0O0/OooO0o0/OooO00o/OooO0O0;->o00O0o0o()Z
    ...
    invoke-virtual {v5}, LOooO0O0/OooO0o0/OooO00o/OooO0O0;->o00OOoo()Z
    ...
    invoke-virtual {v0}, LOooO0O0/OooO0o0/OooO00o/OooO0O0;->oOO00O()Z
    ...
    invoke-virtual {v5}, LOooO0O0/OooO0o0/OooO00o/OooO0O0;->o000o0oo()Z
...
.method public static final getSupportedReferenceConfig(IILcom/android/camera2/CameraCapabilities;Z)Lcom/android/camera/data/data/config/SupportedConfigs;
    .locals 1

    new-instance p2, Lcom/android/camera/data/data/config/SupportedConfigs;

    invoke-direct {p2}, Lcom/android/camera/data/data/config/SupportedConfigs;-><init>()V
    ...
    invoke-virtual {p2, v0}, Lcom/android/camera/data/data/config/SupportedConfigs;->add(I)Lcom/android/camera/data/data/config/SupportedConfigs;
    ...
    invoke-virtual {p2, p0}, Lcom/android/camera/data/data/config/SupportedConfigs;->add(I)Lcom/android/camera/data/data/config/SupportedConfigs;
...
.method public static final getSupportedTopConfigs(IIZ)Lcom/android/camera/data/data/config/SupportedConfigs;
    ...
    invoke-virtual {v3, v1, v0}, Lcom/android/camera/module/loader/camera2/Camera2DataContainer;->getCapabilitiesByBogusCameraId(II)Lcom/android/camera2/CameraCapabilities;
    ...
    invoke-virtual {v8}, Lcom/android/camera/data/data/global/DataItemGlobal;->isVideoCastIntent()Z
    ...
    invoke-virtual {v5}, Lcom/android/camera/data/data/runing/DataItemRunning;->supportTopShineEntry()Z
    ...
    :cond_2
    invoke-virtual {v4}, Lcom/android/camera/data/data/config/DataItemConfig;->supportHdr()Z
    ...
    :cond_3
    invoke-virtual {v4}, Lcom/android/camera/data/data/config/DataItemConfig;->supportAi()Z
    ...
    :cond_4
    invoke-virtual {v5}, Lcom/android/camera/data/data/runing/DataItemRunning;->supportSuperMacroMode()Z
    ...
    :cond_5
    invoke-virtual {v6}, LOooO0O0/OooO0o0/OooO00o/OooO0O0;->oo0oOO0()Z
    ...
    :cond_7
    invoke-virtual {v5}, Lcom/android/camera/data/data/runing/DataItemRunning;->supportUltraPixelPortrait()Z

    move-result v0

    if-eqz v0, :cond_8

    invoke-virtual {v3}, Lcom/android/camera2/CameraCapabilities;->isSupportedSuperPortrait()Z
    ...
    :cond_8
    invoke-virtual {v4}, Lcom/android/camera/data/data/config/DataItemConfig;->supportBokeh()Z
    ...
    invoke-interface {v2}, Lcom/android/camera/protocol/ModeProtocol$PresentationDisplay;->isModeSupportPresentation()Z
    ...
    :cond_a
    invoke-static {v10, v12}, Lcom/android/camera/data/data/config/SupportedConfigFactory;->createConfigItem(II)Lcom/android/camera/data/data/config/TopConfigItem;
    ...
    invoke-virtual {v6}, LOooO0O0/OooO0o0/OooO00o/OooO0O0;->o00O00OO()Z
    ...
    invoke-static {v0, v12}, Lcom/android/camera/data/data/config/SupportedConfigFactory;->createConfigItem(II)Lcom/android/camera/data/data/config/TopConfigItem;
    ...
    :pswitch_2
    invoke-static {v9, v12}, Lcom/android/camera/data/data/config/SupportedConfigFactory;->createConfigItem(II)Lcom/android/camera/data/data/config/TopConfigItem;
    ...
    invoke-virtual {v6}, LOooO0O0/OooO0o0/OooO00o/OooO0O0;->o0O000O()Z
    ...
    :pswitch_10
    invoke-virtual {v6}, LOooO0O0/OooO0o0/OooO00o/OooO0O0;->o00Oo0Oo()Z
    ...
    invoke-virtual {v6}, LOooO0O0/OooO0o0/OooO00o/OooO0O0;->o00Oo0o()Z
    ...
    invoke-static {v15, v12}, Lcom/android/camera/data/data/config/SupportedConfigFactory;->createConfigItem(II)Lcom/android/camera/data/data/config/TopConfigItem;
    ...
    invoke-static {v3, v12}, Lcom/android/camera/data/data/config/SupportedConfigFactory;->createConfigItem(II)Lcom/android/camera/data/data/config/TopConfigItem;
    ...
    invoke-virtual {v4}, Lcom/android/camera/data/data/config/DataItemConfig;->getManuallyFocus()Lcom/android/camera/data/data/config/ComponentManuallyFocus;
    ...
    invoke-virtual {v3}, Lcom/android/camera2/CameraCapabilities;->isAFRegionSupported()Z

    :cond_22
    invoke-virtual {v3}, Lcom/android/camera2/CameraCapabilities;->isSupportVideoFilter()Z

    move-result v0

    if-eqz v0, :cond_23

    invoke-virtual {v3}, Lcom/android/camera2/CameraCapabilities;->isSupportVideoMasterFilter()Z
    ...
    invoke-direct {v2, v1}, Lcom/android/camera/data/data/config/TopConfigItem;-><init>(I)V

    invoke-interface {v7, v0, v2}, Ljava/util/List;->set(ILjava/lang/Object;)Ljava/lang/Object;

    :goto_8
    invoke-static {v7}, Lcom/android/camera/data/data/config/TopViewPositionArray;->fillNotUseViewPosition(Ljava/util/List;)Lcom/android/camera/data/data/config/SupportedConfigs;
    ...
    invoke-virtual {v5}, Lcom/android/camera/data/data/runing/DataItemRunning;->supportUltraPixel()Z
    ...
    invoke-static {v8, v12}, Lcom/android/camera/data/data/config/SupportedConfigFactory;->createConfigItem(II)Lcom/android/camera/data/data/config/TopConfigItem;
    ...
    invoke-virtual {v6}, LOooO0O0/OooO0o0/OooO00o/OooO0O0;->o00OooOo()Z
    ...
    invoke-static {v1, v12}, Lcom/android/camera/data/data/config/SupportedConfigFactory;->createConfigItem(II)Lcom/android/camera/data/data/config/TopConfigItem;
