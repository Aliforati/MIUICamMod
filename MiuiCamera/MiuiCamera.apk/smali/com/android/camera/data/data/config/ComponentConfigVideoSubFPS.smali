...
.method private initItem(ILjava/util/List;Lcom/android/camera2/CameraCapabilities;Ljava/util/List;ILcom/android/camera/data/data/config/ComponentConfigVideoSubQuality;)V
    ...
    invoke-virtual {v5, v4}, Lcom/android/camera/data/data/config/ComponentConfigVideoSubQuality;->getComponentValue(I)Ljava/lang/String;
    ...
    invoke-direct {v3, v8, v8, v4, v5}, Lcom/android/camera/data/data/ComponentDataItem;-><init>(IIILjava/lang/String;)V
    ...
    :cond_6
    invoke-virtual/range {p3 .. p3}, Lcom/android/camera2/CameraCapabilities;->get8KMaxFpsSupported()I
    ...
    invoke-direct {v1, v12, v12, v6, v7}, Lcom/android/camera/data/data/ComponentDataItem;-><init>(IIILjava/lang/String;)V
    ...
    invoke-direct {v5, v12, v12, v6, v7}, Lcom/android/camera/data/data/ComponentDataItem;-><init>(IIILjava/lang/String;)V
    ...
    invoke-static {v5, v6, v3, v1}, Lcom/android/camera/CameraSettings;->isSupportFpsRange(IIILcom/android/camera2/CameraCapabilities;)Z
    ...
    invoke-direct {v3, v15, v15, v13, v14}, Lcom/android/camera/data/data/ComponentDataItem;-><init>(IIILjava/lang/String;)V
    ...
    :cond_8
    invoke-static/range {p3 .. p3}, Lcom/android/camera/data/data/config/ComponentConfigVideoSubFPS;->isSupported4K120Fps(Lcom/android/camera2/CameraCapabilities;)Z

    move-result v3

    if-nez v3, :cond_b

    invoke-virtual/range {p3 .. p3}, Lcom/android/camera2/CameraCapabilities;->getCameraRoleIds()[I
    ...
    :cond_9
    invoke-virtual/range {p3 .. p3}, Lcom/android/camera2/CameraCapabilities;->getCameraRoleId()I
    ...
    invoke-virtual {v1, v10}, Lcom/android/camera/module/loader/camera2/Camera2DataContainer;->getCapabilities(I)Lcom/android/camera2/CameraCapabilities;

    move-result-object v1

    invoke-static {v1}, Lcom/android/camera/data/data/config/ComponentConfigVideoSubFPS;->isSupported4K120Fps(Lcom/android/camera2/CameraCapabilities;)Z
    ...
    :goto_4
    invoke-static/range {p1 .. p1}, Lcom/android/camera/CameraSettings;->isSubtitleEnabled(I)Z
    ...
    invoke-direct {v4, v12, v12, v6, v7}, Lcom/android/camera/data/data/ComponentDataItem;-><init>(IIILjava/lang/String;)V
    ...
    invoke-static {v4, v5, v3, v1}, Lcom/android/camera/CameraSettings;->isSupportFpsRange(IIILcom/android/camera2/CameraCapabilities;)Z
    ...
    invoke-direct {v1, v15, v15, v13, v14}, Lcom/android/camera/data/data/ComponentDataItem;-><init>(IIILjava/lang/String;)V
...
.method public getKey(I)Ljava/lang/String;
    ...
    const-string p1, "pref_video_sub_fps_key"
...
.method public reInit(IILcom/android/camera2/CameraCapabilities;ILcom/android/camera/data/data/config/ComponentConfigVideoSubQuality;)V
    ...
    sget-object p3, Lcom/android/camera/data/data/config/ComponentConfigVideoSubFPS;->ALL_FPS_ITEMS:Ljava/util/List;

    invoke-virtual {p0, p2, p3}, Lcom/android/camera/data/data/ComponentData;->copyList(Ljava/util/List;Ljava/util/List;)V

    :cond_2
    sget-object p2, Lcom/android/camera/data/data/config/ComponentConfigVideoSubFPS;->ALL_FPS_ITEMS:Ljava/util/List;

    sget-object p3, Lcom/android/camera/data/data/config/ComponentConfigVideoSubFPS;->ALL_FPS_VALUE:Ljava/util/List;

    invoke-virtual {p0, p2, p3}, Lcom/android/camera/data/data/ComponentData;->filterSupprotedItems(Ljava/util/List;Ljava/util/List;)Ljava/util/List;

    sget-object p2, Lcom/android/camera/data/data/config/ComponentConfigVideoSubFPS;->ALL_FPS_ITEMS:Ljava/util/List;

    invoke-virtual {p0, p2, v7}, Lcom/android/camera/data/data/ComponentData;->copyList(Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-virtual {p0, v7, p3}, Lcom/android/camera/data/data/ComponentData;->filterSupprotedItems(Ljava/util/List;[Ljava/lang/String;)Ljava/util/List;
