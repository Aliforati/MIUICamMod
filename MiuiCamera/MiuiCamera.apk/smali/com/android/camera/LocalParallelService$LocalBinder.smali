...
# instance fields
.field public mAlivePostProcessor:Ljava/util/List;
...
.field public mCurrentBufferFormat:Lcom/xiaomi/engine/BufferFormat;

.field public mCurrentParams:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.method private onPostProcessorClosed(Lcom/xiaomi/camera/core/PostProcessor;)V
    ...
    iget-object v1, p0, Lcom/android/camera/LocalParallelService$LocalBinder;->mAlivePostProcessor:Ljava/util/List;
...
.method public configCaptureOutputBuffer(Ljava/util/List;I)Ljava/util/List;
    ...
    invoke-virtual {p2}, Lcom/xiaomi/camera/core/PostProcessor;->getSurfaceList()Ljava/util/List;
    ...
    invoke-virtual {p2, p1}, Lcom/xiaomi/camera/core/PostProcessor;->configHALOutputSurface(Ljava/util/List;)Ljava/util/List;
...
.method public configCaptureSession(Lcom/xiaomi/engine/BufferFormat;Lcom/android/camera/CameraSize;)V
    ...
    invoke-virtual {p1, v2, p2}, Lcom/xiaomi/camera/core/PostProcessor;->configCaptureSession(Lcom/xiaomi/engine/BufferFormat;Lcom/android/camera/CameraSize;)V
    ...
    const-string p2, "configCaptureSession: bufferFormat keeps unchanged"
...
.method public isIdle()Z
    ...
    invoke-virtual {v2}, Lcom/xiaomi/camera/core/PostProcessor;->isIdle()Z
