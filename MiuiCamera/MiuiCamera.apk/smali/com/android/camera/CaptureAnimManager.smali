...
.method public drawAnimation(Lcom/android/gallery3d/ui/GLCanvas;Lcom/android/gallery3d/ui/RawTexture;)Z
    ...
    invoke-virtual {v5}, Lcom/android/camera/data/data/runing/DataItemRunning;->getNightCaptureAnimDuration()I

    move-result v5

    iget v6, v0, Lcom/android/camera/CaptureAnimManager;->mAnimType:I
    ...
    iget v8, v0, Lcom/android/camera/CaptureAnimManager;->mY:F
    ...
    invoke-static {v5, v8, v11, v12}, Lcom/android/camera/dualvideo/render/RectUtil;->createLTWH(IIII)Landroid/graphics/Rect;

    move-result-object v5

    invoke-direct {v3, v2, v5}, Lcom/android/camera/effect/draw_mode/DrawBasicTexAttribute;-><init>(Lcom/android/gallery3d/ui/BasicTexture;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v2, v4}, Lcom/android/camera/effect/GLCanvasState;->setBlendAlpha(F)V
