...
.method public static createThumbnailFromUri(Landroid/content/Context;Landroid/net/Uri;Z)Lcom/android/camera/Thumbnail;
    ...
    invoke-static {v9, v10, v11, v4, v7}, Landroid/provider/MediaStore$Images$Thumbnails;->getThumbnail(Landroid/content/ContentResolver;JILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v6, v15, v3, v2}, Lcom/android/camera/Thumbnail;->getScaledBitmapFromFile(Ljava/lang/String;III)Landroid/graphics/Bitmap;
    ...
    :cond_c
    invoke-static {v6, v15, v3}, Lcom/android/camera/Thumbnail;->createVideoThumbnailBitmap(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    ...
    :goto_7
    invoke-static {v0, v7, v5, v1}, Lcom/android/camera/Thumbnail;->createThumbnail(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/Thumbnail;
...
.method public static getLastThumbnailFromContentResolver(Landroid/content/Context;[Lcom/android/camera/Thumbnail;Landroid/net/Uri;)I
    ...
    invoke-static {v5, v0, v10}, Lcom/android/camera/log/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    iget v8, v2, Lcom/android/camera/Thumbnail$Media;->orientation:I

    invoke-static {v7, v0, v5, v8}, Lcom/android/camera/Thumbnail;->getScaledBitmapFromFile(Ljava/lang/String;III)Landroid/graphics/Bitmap;
    ...
    iget-wide v5, v2, Lcom/android/camera/Thumbnail$Media;->id:J
    ...
    iget-object v1, v2, Lcom/android/camera/Thumbnail$Media;->path:Ljava/lang/String;
    ...
    invoke-static {v5, v8, v0, v4, v1}, Lcom/android/camera/Thumbnail;->createThumbnail(Landroid/net/Uri;Landroid/graphics/Bitmap;IZZ)Lcom/android/camera/Thumbnail;
