...
# static fields
.field public static final TAG:Ljava/lang/String; = "ViberatorContext"

.field public static volatile mInstance:Lcom/android/camera/lib/compatibility/related/vibrator/ViberatorContext;


# instance fields
.field public mIsSnapClickViberatorEnable:Z

.field public mViberator:Lcom/android/camera/lib/compatibility/related/vibrator/IViberatorStrategy;
...
.method private isViberatorReady()Z
    ...
    iget-object v0, p0, Lcom/android/camera/lib/compatibility/related/vibrator/ViberatorContext;->mViberator:Lcom/android/camera/lib/compatibility/related/vibrator/IViberatorStrategy;
...
.method public performBokehAdjust()V
    ...
    invoke-interface {v0}, Lcom/android/camera/lib/compatibility/related/vibrator/IViberatorStrategy;->performBokehAdjust()V
...
.method public performBurstCapture()V
    ...
    invoke-interface {v0}, Lcom/android/camera/lib/compatibility/related/vibrator/IViberatorStrategy;->performBurstCapture()V
...
.method public performEVChange()V
    ...
    invoke-interface {v0}, Lcom/android/camera/lib/compatibility/related/vibrator/IViberatorStrategy;->performEVChange()V
...
.method public performFocusValueLargeChangedInManual()V
    ...
    invoke-interface {v0}, Lcom/android/camera/lib/compatibility/related/vibrator/IViberatorStrategy;->performFocusValueLargeChangedInManual()V
...
.method public performFocusValueLightChangedInManual()V
    ...
    invoke-interface {v0}, Lcom/android/camera/lib/compatibility/related/vibrator/IViberatorStrategy;->performFocusValueLightChangedInManual()V
...
.method public performModeSwitch()V
    ...
    invoke-interface {v0}, Lcom/android/camera/lib/compatibility/related/vibrator/IViberatorStrategy;->performModeSwitch()V
...
.method public performSelectZoomLight()V
    ...
    invoke-interface {v0}, Lcom/android/camera/lib/compatibility/related/vibrator/IViberatorStrategy;->performSelectZoomLight()V
...
.method public performSelectZoomNormal()V
    ...
    invoke-interface {v0}, Lcom/android/camera/lib/compatibility/related/vibrator/IViberatorStrategy;->performSelectZoomNormal()V
...
.method public performSlideScaleNormal()V
    ...
    invoke-interface {v0}, Lcom/android/camera/lib/compatibility/related/vibrator/IViberatorStrategy;->performSlideScaleNormal()V
...
.method public performSnapClick()V
    ...
    invoke-interface {v0}, Lcom/android/camera/lib/compatibility/related/vibrator/IViberatorStrategy;->performSnapClick()V
...
.method public performSwitchCamera()V
    ...
    invoke-interface {v0}, Lcom/android/camera/lib/compatibility/related/vibrator/IViberatorStrategy;->performSwitchCamera()V
